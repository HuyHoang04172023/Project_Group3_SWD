        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinValue = table.Column<decimal>(type: "decimal(38,0)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<decimal>(type: "decimal(38,0)", nullable: true),
                    Quantity = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepplyCommentId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAmountBefore = table.Column<decimal>(type: "decimal(38,0)", nullable: true),
                    DiscountAmount = table.Column<decimal>(type: "decimal(38,0)", nullable: true),
                    TotalAmountAfter = table.Column<decimal>(type: "decimal(38,0)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReplyFeedbackId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(type: "int", nullable: true),
                    Quantity = table.Column<int>(type: "int", nullable: true),
                    UnitPrice = table.Column<decimal>(type: "decimal(38,0)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comment_RepplyCommentId",
                table: "Comment",
                column: "RepplyCommentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Feedback_ReplyFeedbackId",
                table: "Feedback",
                column: "ReplyFeedbackId");
